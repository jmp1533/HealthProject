-- Table Name: 고객(user)
INSERT INTO users VALUES('user1','111',1,'좌우명','홍길동',null,'010-0000-0000','user1@mail.com','111-111','서울시종로구관철동&땡땡아파트','19890101',2,40, '13/11/01',1);
&땡땡아파트
INSERT INTO users VALUES('user2','111',2,'별명은..','홍길서',null,'010-0000-0001','user2@mail.com','222-222','서울시성북구안암동&땡땡빌라','19900101',1,60,'13/11/01',1);
&땡땡빌라
INSERT INTO users VALUES('user3','111',3,'00초등학교','홍길남',null,'010-0000-0002','user3@mail.com','333-333','서울시광진구자양동&땡땡아파트','19850101',1,55,'13/11/01',1);
&땡땡아파트
INSERT INTO users VALUES('user4','111',1,'좌우명','홍길북',null,'010-0000-2222','user4@mail.com','123-111','서울시마포구연남동&땡땡주택','19800101',1,60,'13/11/01',1);
&땡땡주택

-- Table Name: 트레이너
INSERT INTO trainers VALUES('trainer1','123','김철수1','123-123','서울시강북구미아동&땡땡아파트','아메리카핫요가','010-111-1111','19800202','trainer1@mail.com',null,1,'좌우명',1,180,70,'안녕하세요.트레이너1입니다.','13/10/01',2, 2);
&땡땡아파트
INSERT INTO trainers VALUES('trainer2','123','이철수2','123-111','서울시마포구합정동&땡땡주택','합정헬스','010-111-2222','19850102','trainer2@mail.com',null,2,'별명',1,180,60,'안녕하세요.트레이너2입니다.','13/10/01',1, 1);
&땡땡주택
INSERT INTO trainers VALUES('trainer3','123','박철수3','123-122','서울시송파구석촌동&땡땡아파트','헬스1','010-111-1111','19800202','trainer3@mail.com',null,1,'좌우명',1,160,50,'안녕하세요.트레이너3입니다.','13/10/01',1, 1);
&땡땡아파트
INSERT INTO trainers VALUES('trainer4','123','강철수4','123-111','서울시마포구망원동&땡땡주택','헬스2','010-111-2222','19850102','trainer4@mail.com',null,2,'별명',1,180,60,'안녕하세요.트레이너4입니다.','13/10/01',1, 1);
&땡땡주택
INSERT INTO trainers VALUES('trainer5','123','신철수5','123-333','서울시종로구혜화동&땡땡아파트','핫요가1','010-111-1111','19800202','trainer5@mail.com',null,1,'좌우명',1,180,70,'안녕하세요.트레이너5입니다.','13/10/01',1, 1);
&땡땡아파트
INSERT INTO trainers VALUES('trainer6','123','배철수6','123-888','서울시마포구합정동&땡땡빌라','헬스헬스','010-111-2222','19850102','trainer6@mail.com',null,2,'별명',1,180,60,'안녕하세요.트레이너6입니다.','13/10/01',1, 1);
&땡땡빌라
INSERT INTO trainers VALUES('trainer7','123','안철수7','123-177','서울시강북구미아동&땡땡아파트','헬스장','010-111-1111','19800202','trainer7@mail.com',null,1,'좌우명',1,180,70,'안녕하세요.트레이너7입니다.','13/10/01',1, 1);
&땡땡아파트
INSERT INTO trainers VALUES('trainer8','123','소철수8','123-666','서울시마포구합정동&땡땡주택','운동','010-111-2222','19850102','trainer8@mail.com',null,2,'별명',1,180,60,'안녕하세요.트레이너8입니다.','13/10/01',1, 1);
&땡땡주택
INSERT INTO trainers VALUES('trainer9','123','박철수9','123-122','서울시송파구석촌동&땡땡아파트','헬스1','010-111-1111','19800202','trainer3@mail.com',null,1,'좌우명',1,160,50,'안녕하세요.트레이너3입니다.','13/10/01',1, 1);
&땡땡아파트
INSERT INTO trainers VALUES('trainer10','123','강철수10','123-111','서울시마포구망원동&땡땡주택','헬스2','010-111-2222','19850102','trainer4@mail.com',null,2,'별명',1,180,60,'안녕하세요.트레이너4입니다.','13/10/01',1, 1);
&땡땡주택
INSERT INTO trainers VALUES('trainer11','123','박철수11','123-122','서울시송파구석촌동&땡땡아파트','헬스1','010-111-1111','19800202','trainer3@mail.com',null,1,'좌우명',1,160,50,'안녕하세요.트레이너11입니다.','13/10/01',1, 1);
&땡땡아파트
INSERT INTO trainers VALUES('trainer12','123','강철수12','123-111','서울시마포구망원동&땡땡주택','헬스2','010-111-2222','19850102','trainer4@mail.com',null,2,'별명',1,180,60,'안녕하세요.트레이너12입니다.','13/10/01',1, 1);
&땡땡주택

-- Table Name: 트레이너관리유저
INSERT INTO management VALUES(management_SEQ.NEXTVAL,'trainer1','user1','13/11/02');
INSERT INTO management VALUES(management_SEQ.NEXTVAL,'trainer1','user2','13/12/01');
INSERT INTO management VALUES(management_SEQ.NEXTVAL,'trainer2','user3',sysdate);

-- Table Name: 로그기록(트레이너) 
INSERT INTO trainerslog VALUES(trainerslog_SEQ.NEXTVAL,'trainer1','13/10/01');
INSERT INTO trainerslog VALUES(trainerslog_SEQ.NEXTVAL,'trainer1','13/10/02');
INSERT INTO trainerslog VALUES(trainerslog_SEQ.NEXTVAL,'trainer1','13/10/29');
INSERT INTO trainerslog VALUES(trainerslog_SEQ.NEXTVAL,'trainer2','13/10/01');

-- Table Name: 추천식단 
INSERT INTO recommendmenu VALUES(1, 1,'2000',sysdate);
INSERT INTO recommendmenu VALUES(2, 2,'2134',sysdate);
INSERT INTO recommendmenu VALUES(3, 3,'2222',sysdate);

-- Table Name: 조인상태 
INSERT INTO join VALUES(join_SEQ.NEXTVAL,'trainer1','user1','13/11/02','false');
INSERT INTO join VALUES(join_SEQ.NEXTVAL,'trainer1','user2','13/12/01','false');
INSERT INTO join VALUES(join_SEQ.NEXTVAL,'trainer2','user3', sysdate,'false');

-- Table Name: 체중  
INSERT INTO userinfo VALUES(userinfo_SEQ.NEXTVAL,'user1',45,150,'13/11/01');
INSERT INTO userinfo VALUES(userinfo_SEQ.NEXTVAL,'user1',45,150,'13/11/02');
INSERT INTO userinfo VALUES(userinfo_SEQ.NEXTVAL,'user1',43,150,'13/11/10');
INSERT INTO userinfo VALUES(userinfo_SEQ.NEXTVAL,'user2',70,160,'13/11/01');
INSERT INTO userinfo VALUES(userinfo_SEQ.NEXTVAL,'user2',68,160,'13/11/02');
INSERT INTO userinfo VALUES(userinfo_SEQ.NEXTVAL,'user2',67,160,'13/11/10');
...
INSERT INTO userlog VALUES(userlog_SEQ.NEXTVAL,'user2','13/11/01');
INSERT INTO userlog VALUES(userlog_SEQ.NEXTVAL,'user3','13/11/01');

-- Table Name: 피플게시판(유저) 
INSERT INTO people VALUES(people_SEQ.NEXTVAL,'user1',null,'14/12/23','10:30','같이운동해요','같이 운동해요~~~~~~~','서울 종로근처',0);
INSERT INTO people VALUES(people_SEQ.NEXTVAL,'user2',null,'14/01/02','02:30','운동친구구합니다','함께운동할 운동친구 구해요~','서울 성북구',0);

-- Table Name: 피플게시판 댓글
INSERT INTO peoplereple VALUES(peoplereple_SEQ.NEXTVAL,1,'user1','저도종로살아요!같이해요',sysdate);
INSERT INTO peoplereple VALUES(peoplereple_SEQ.NEXTVAL,1,'user1','시간이안맞네여ㅠㅠ',sysdate);

-- Table Name: 다이어리
INSERT INTO diary VALUES(diary_SEQ.NEXTVAL,'user1','11월1일오늘의일기!','다이어트시작~살빼자!','13/12/01');
INSERT INTO diary VALUES(diary_SEQ.NEXTVAL,'user1','운동은힘들다..','둘째날..너무너무힘들다','13/12/12');


-- Table Name: 다이어리 댓글 
INSERT INTO diaryreple VALUES(diaryreple_SEQ.NEXTVAL,1,'trainer1','반갑습니다.','13/11/01');
INSERT INTO diaryreple VALUES(diaryreple_SEQ.NEXTVAL,2,'trainer1','힘내세요~홧팅!','13/11/02');

-- Table Name: 다이어리-식단 
INSERT INTO diarymenu VALUES(diarymenu_SEQ.NEXTVAL,1,'07:30',null,200,200,200,200,200);
INSERT INTO diarymenu VALUES(diarymenu_SEQ.NEXTVAL,1,'12:00',null,200,200,200,200,200);
INSERT INTO diarymenu VALUES(diarymenu_SEQ.NEXTVAL,1,'06:00',null,200,200,200,200,200);
INSERT INTO diarymenu VALUES(diarymenu_SEQ.NEXTVAL,2,'07:30',null,200,200,200,200,200);
INSERT INTO diarymenu VALUES(diarymenu_SEQ.NEXTVAL,2,'12:00',null,200,200,200,200,200);
INSERT INTO diarymenu VALUES(diarymenu_SEQ.NEXTVAL,2,'06:00',null,200,200,200,200,200);

-- Table Name: 성공후기게시판
INSERT INTO review VALUES(review_SEQ.NEXTVAL,'user1','성공후기에요~',sysdate,null,null,'다이어트성공했어요',0);
INSERT INTO review VALUES(review_SEQ.NEXTVAL,'user2','운동후기',sysdate,null,null,'다이어트성공했어요',0);

-- Table Name: 성공후기추천인 
INSERT INTO reviewrecommend VALUES(reviewrecommend_SEQ.NEXTVAL,1,'user2');
INSERT INTO reviewrecommend VALUES(reviewrecommend_SEQ.NEXTVAL,1,'user3');
INSERT INTO reviewrecommend VALUES(reviewrecommend_SEQ.NEXTVAL,1,'user4');
INSERT INTO reviewrecommend VALUES(reviewrecommend_SEQ.NEXTVAL,2,'user1');


-- Table Name: 성공후기댓글 
INSERT INTO reviewreple VALUES(reviewreple_SEQ.NEXTVAL,1,'user2','ㅊㅋㅊㅋ~',sysdate);
...
-- Table Name: 팁&노하우
INSERT INTO tiptitle VALUES(tiptitle_SEQ.NEXTVAL,1,'user1','바나나로 다이어트해보세요', '바나나랑 물한잔이면 포만감 대박~',sysdate,0);

-- Table Name: 팁&노하우게시판댓글 
INSERT INTO tipreple VALUES(tipreple_SEQ.NEXTVAL,1,'user1','유용한정보네요',sysdate);
...
-- Table Name: 자유게시판
INSERT INTO freetitle VALUES(freetitle_SEQ.NEXTVAL,'user1','하이하이','하이하이반가워요','13/12/01',0);
INSERT INTO freetitle VALUES(freetitle_SEQ.NEXTVAL,'user2','안녕','하이하이반가워요','13/12/03',null);
...
-- Table Name: 문의사항카테고리
INSERT INTO questioncategory VALUES(questioncategory_SEQ.NEXTVAL,'회원가입');
INSERT INTO questioncategory VALUES(questioncategory_SEQ.NEXTVAL,'게시판');
INSERT INTO questioncategory VALUES(questioncategory_SEQ.NEXTVAL,'탈퇴');


-- Table Name: 1:1문의게시판 
INSERT INTO questionboard VALUES(questionboard_SEQ.NEXTVAL,'user1',2,'게시판...','글이안써짐...',null,sysdate);
INSERT INTO questionboard VALUES(questionboard_SEQ.NEXTVAL,'user4',3,'탈퇴는어디서?','탈퇴하고싶음',null,sysdate);
...
-- Table Name: 웹관리자 
INSERT INTO admins VALUES('admin','111','13/05/05');
...
-- Table Name: 공지게시판 
INSERT INTO notification VALUES(notification_SEQ.NEXTVAL,'admin','공지사항입니다1','공지공지공지....',0,'13/10/10');
INSERT INTO notification VALUES(notification_SEQ.NEXTVAL,'admin','공지사항입니다2','공지공지공지....',0,'13/10/15');
INSERT INTO notification VALUES(notification_SEQ.NEXTVAL,'admin','공지사항입니다3','공지공지공지....',0,'13/10/20');
INSERT INTO notification VALUES(notification_SEQ.NEXTVAL,'admin','공지사항입니다4','공지공지공지....',0,'13/11/10');
INSERT INTO notification VALUES(notification_SEQ.NEXTVAL,'admin','공지사항입니다5','공지공지공지....',0,'13/12/01');

-- Table Name: 업체 
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer1','111-11-11111','헬스1','서울시 종로구&땡땡헬스장','111-111','010-0101-0101','aa@mail.com','종로구에 위치한 헬스1입니다.',0,0,2, sysdate);
&땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer2','122-22-22222','헬스2','서울시 마포구&땡땡땡헬스장','111-222','010-0101-2222','bb@mail.com','마포구에 위치한 헬스2입니다.',0,0,1, sysdate);
&땡땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer3','333-33-33333','헬스3','서울시 종로구&땡땡헬스장','111-333','010-0101-0111','sdhlkwe1@mail.com','도봉구에 위치한 헬스1입니다.',0,0,1, sysdate);
&땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer4','44-444-44444','헬스4','서울시 마포구&땡땡땡헬스장','111-444','010-0101-2362','dkhg9@mail.com','강북구에 위치한 헬스3입니다.',0,0,1, sysdate);
&땡땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer5','55-555-55555','헬스5','서울시 종로구&땡땡헬스장','111-555','010-0367-3467','dkeh6@mail.com','강남구에 위치한 헬스4입니다.',0,0,1, sysdate);
&땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer6','66-666-66666','헬스6','서울시 마포구&땡땡땡헬스장','111-666','010-4578-2323','dkwe6@mail.com','강남구에 위치한 헬스5입니다.',0,0,1, sysdate);
&땡땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer7','77-777-77777','헬스7','서울시 종로구&땡땡헬스장','111-777','010-5686-3494','kht532@mail.com','강서구에 위치한 헬스6입니다.',0,0,1, sysdate);
&땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer8','88-888-88888','헬스8','서울시 마포구&땡땡땡헬스장','111-888','010-8546-4590','dkhf19@mail.com','마포구에 위치한 헬스7입니다.',0,0,1, sysdate);
&땡땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer9','99-999-99999','헬스9','서울시 종로구&땡땡헬스장','111-999','010-8564-3894','ejfd@mail.com','성북구에 위치한 헬스8입니다.',0,0,1, sysdate);
&땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer10','10-101-01010','헬스10','서울시 마포구&땡땡땡헬스장','111-101','010-4564-5574','edsftw@mail.com','노원구에 위치한 헬스9입니다.',0,0,1, sysdate);
&땡땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer11','11-111-11111','헬스11','서울시 종로구&땡땡헬스장','111-111','010-7456-4574','hdgs@mail.com','강북구에 위치한 헬스10입니다.',0,0,1, sysdate);
&땡땡헬스장
INSERT INTO business VALUES(business_SEQ.NEXTVAL,'trainer12','12-121-21212','헬스12','서울시 마포구&땡땡땡헬스장','111-121','010-0101-4583','sjwkf@mail.com','마포구에 위치한 헬스11입니다.',0,0,1, sysdate);
&땡땡땡헬스장

-- Table Name: 업체이미지
INSERT INTO businessimg VALUES(businessimg_SEQ.NEXTVAL,1,null);
INSERT INTO businessimg VALUES(businessimg_SEQ.NEXTVAL,2,null);
INSERT INTO businessimg VALUES(businessimg_SEQ.NEXTVAL,12, 'http://www.동네헬스.com/gosi/photoimg/20120810124657.jpg');
INSERT INTO businessimg VALUES(businessimg_SEQ.NEXTVAL,12, 'http://www.동네헬스.com/gosi/photoimg/20120810124646.jpg');
INSERT INTO businessimg VALUES(businessimg_SEQ.NEXTVAL,12, 'http://www.동네헬스.com/gosi/photoimg/20120810124703.jpg');
INSERT INTO businessimg VALUES(businessimg_SEQ.NEXTVAL,12, 'http://www.동네헬스.com/gosi/photoimg/20120810124708.jpg');

...
public class admin_mservice_qna_Controller {
	@Inject
	admin_mservice_qna_service qna_service;
	...
	public ModelAndView list(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum,
		...
		PageUtil pu = null;
		List<admin_mservice_qna_Dto> list = null;
		int totalRowCount = 0;
		...
		totalRowCount = qna_service.search(map);
	...
	public String reple(
			...
			@RequestParam("q_num") int q_num, @RequestParam("qr_content") String qr_content) {

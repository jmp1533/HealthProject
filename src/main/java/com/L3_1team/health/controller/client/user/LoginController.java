...
public class LoginController {
	...
	public String loginSelect(@Param("id") String id, @Param("password") String password, HttpServletRequest request) {

		HashMap<String, String> map = new HashMap<String, String>();
		String viewReturn = "redirect:/";
		String userlogid = "";
		String trainerlogid = ""; 
		...
		userlogid = userService.login(map);
		trainerlogid = trainerService.login(map);
		...
		if (userlogid != null) {
			...
			if (trainerlogid != null) {
				...
				viewReturn = ".client.user.insert.Login";	
			}			
		}

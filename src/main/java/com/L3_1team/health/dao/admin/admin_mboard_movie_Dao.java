...
@Repository
public class admin_mboard_movie_Dao {
	@Inject
	...
	public int update(Health_movie_Dto dto) {
		return sqlSession.update("com.L3_1team.health.mybatis.menu.health_movieMapper.update", dto);
	}
	...
	public int delete(int v_num) {
		return sqlSession.delete("com.L3_1team.health.mybatis.menu.health_movieMapper.delete", v_num);
	}

	/*
	 * public Health_movie_Dto prev(int num){ return sqlSession.selectOne(
	 * "com.L3_1team.health.mybatis.menu.health_movieMapper.prev",num); } public
	 * Health_movie_Dto next(int num){ return sqlSession.selectOne(
	 * "com.L3_1team.health.mybatis.menu.health_movieMapper.next",num); }
	 */
}

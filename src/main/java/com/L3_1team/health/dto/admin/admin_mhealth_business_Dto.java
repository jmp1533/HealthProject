...
public class admin_mhealth_business_Dto {
	private int b_num;
	private String t_id;
	...
	public admin_mhealth_business_Dto() {
	}

	public admin_mhealth_business_Dto(int b_num, String t_id, String b_corporatenum, String b_name, String b_addr,
			String zipcode, String b_phone, String b_email, String b_content, float b_x, float b_y, int b_condition,
			Timestamp b_date, int bi_num, String bi_img) {
		super();
		this.b_num = b_num;
		this.t_id = t_id;

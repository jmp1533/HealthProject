...
public class admin_mservice_qna_Dto {
	private int qcate_num;
	...
	public admin_mservice_qna_Dto() {
	}

	public admin_mservice_qna_Dto(int qcate_num, String qcate_name, int q_num, String id, String q_title,
			String q_content, String q_img, Timestamp q_date) {
		super();

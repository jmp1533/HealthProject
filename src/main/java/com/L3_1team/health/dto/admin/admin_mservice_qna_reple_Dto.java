...
public class admin_mservice_qna_reple_Dto {
	private int qr_num;
	private int q_num;
	...
	public admin_mservice_qna_reple_Dto() {
	}

	public admin_mservice_qna_reple_Dto(int qr_num, int q_num, String admin_id, String qr_content, Timestamp qr_date) {
		super();
		this.qr_num = qr_num;
		this.q_num = q_num;
	...
	public String toString() {
		return "admin_mservice_qna_reple_Dto [qr_num=" + qr_num + ", q_num=" + q_num + ", admin_id=" + admin_id
				+ ", qr_content=" + qr_content + ", qr_date=" + qr_date + "]";
	}

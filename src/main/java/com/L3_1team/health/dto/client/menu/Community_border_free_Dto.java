...
public class Community_border_free_Dto {
	...
	public Community_border_free_Dto() {
	}

	public Community_border_free_Dto(int free_num, String id, String f_title, String f_content, Timestamp f_date,
			int f_hits) {
		super();

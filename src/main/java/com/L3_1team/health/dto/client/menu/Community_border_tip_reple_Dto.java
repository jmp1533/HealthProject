...
public class Community_border_tip_reple_Dto {
	private int tr_num;
	private int tip_num;
	private String id;
	...
	public Community_border_tip_reple_Dto() {
	}

	public Community_border_tip_reple_Dto(int tr_num, int tip_num, String id, String tr_content, Timestamp tr_date) {
		super();
		this.tr_num = tr_num;

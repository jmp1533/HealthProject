...
public class People_traner_Dto {
	...
	public People_traner_Dto() {
	}

	public People_traner_Dto(String t_id, String t_name, String t_addr, String t_company, String t_phone,
			String t_birth, int t_gender, String t_email, String t_img, int t_weight, int t_height,
			String t_introduction, Timestamp t_date, int t_condition, int t_out) {
		super();
		this.t_id = t_id;
		this.t_name = t_name;
		this.t_addr = t_addr;

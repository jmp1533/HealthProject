...
public class UserDto {
	...
	public UserDto(String u_id, String u_pwd, int u_question, String u_answer, String u_name, String u_img,
			String u_phone, String u_email, String u_zipcode, String u_addr, String u_birth, int u_gender,
			float u_targetweight, Timestamp u_regdate, int u_out) {
		super();
		this.u_id = u_id;
		this.u_pwd = u_pwd;
	...
	public float getU_targetweight() {
		return u_targetweight;
	}

	public void setU_targetweight(float u_targetweight) {
		this.u_targetweight = u_targetweight;
	}
	...
	public String toString() {
		return "UserDto [u_id=" + u_id + ", u_pwd=" + u_pwd + ", u_question=" + u_question + ", u_answer=" + u_answer
				+ ", u_name=" + u_name + ", u_img=" + u_img + ", u_phone=" + u_phone + ", u_email=" + u_email
				+ ", u_zipcode=" + u_zipcode + ", u_addr=" + u_addr + ", u_birth=" + u_birth + ", u_gender=" + u_gender
				+ ", u_targetweight=" + u_targetweight + ", u_regdate=" + u_regdate + ", u_out=" + u_out + "]";
	}
}

...
import com.L3_1team.health.dao.client.menu.Community_tipBorder_Dao;
...
@Service
public class Community_tipBorder_Service implements tip_trans_inter {
	@Inject
	private Community_tipBorder_Dao dao;

	public Community_tipBorder_Dao getDao() {
		return dao;
	}

	public void setDao(Community_tipBorder_Dao dao) {
		this.dao = dao;
	}

...
<h2>동영상 글쓰기</h2>
<form method="post" action="/admin/mboard/movie/health_movie_insert" enctype = "multipart/form-data" id="insert">
	카테고리
	...
	<br/>
	제목 <input type="text" id="v_title" name="v_title"/>	<br/>
	링크 <input type="text" id="v_link" name="v_link"/>	<br/>
...
<textarea name="ir1" id="ir1" rows="40" cols="100" style="display: block;"></textarea>	

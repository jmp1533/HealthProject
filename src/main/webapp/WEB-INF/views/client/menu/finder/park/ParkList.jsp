                    ...
                    <%--이미지 넣을땐 158*50 픽셀로 만들것! --%>
                        ...
                        <div class="list_1">
                            <%--이미지 링크뒤에 글내용 바꾸고 크기 다시 조절해야함 --%>
                                <a href="/client/menu/finder/company/CompanyList">헬스장 검색</a>
                                <%--이미지로 변경해서 각 페이지 초기값으로 링크 연결. --%>
                        </div>
                        <div class="list_2">
                            <a href="/client/menu/finder/park/ParkList" style="background-color: red;">공원
                                위치찾기</a>
                        </div>
                </div>
                <img>
    ...
    -->
                    <table border="1">
                        ...
                        <c:forEach var="parkdto" items="${requestScope.list}">
                            <tr>
                                <td><a
                                        href="/client/menu/finder/park/Parkview?p_idx=${parkdto.p_idx}">${parkdto.p_park}</a>
                                </td>

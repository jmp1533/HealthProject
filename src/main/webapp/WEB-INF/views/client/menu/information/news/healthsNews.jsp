                ...
                <%--이미지 넣을땐 158*50 픽셀로 만들것! --%>
                    ...
                    <div class="list_1" style="background-color: red;">
                        <%--이미지 링크뒤에 글내용 바꾸고 크기 다시 조절해야함 --%>
                            <a href="/client/menu/information/news/healthsNews">건강뉴스</a>
        ...
        <div class="list" style="overflow: hidden;">
            <table>
                ...
                <c:forEach var="dto" items="${dto }">
                    <tr>
                        <td><a href="${dto.link }" target="_blank"><span style="font-size: 19px">${dto.title
                                    }</span></a><br /></td>
                    </tr>
                    <tr>
        ...
        <div class="list_number" style="text-align: center;">
            ...
            <c:choose>
                <c:when test="${pu.startPageNum>10 }">
                    <a
                        href="/client/menu/information/news/healthsNews?pageNum=${pu.startPageNum-1 }&sort=${sort }">[이전]</a>
                </c:when>
                <c:otherwise>
                    [이전]
                </c:otherwise>
            ...
            <c:forEach var="i" begin="${pu.startPageNum }" end="${pu.endPageNum }">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="/client/menu/information/news/healthsNews?pageNum=${i }&sort=${sort }">[${i
                            }]</a>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            <c:choose>
                <c:when test="${pu.endPageNum<pu.totalPageCount }">
                    <a
                        href="/client/menu/information/news/healthsNews?pageNum=${pu.endPageNum+1 }&sort=${sort }">[다음]</a>
                </c:when>
                <c:otherwise>
                    [다음]
                </c:otherwise>

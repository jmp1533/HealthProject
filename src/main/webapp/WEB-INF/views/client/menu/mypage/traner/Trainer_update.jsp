                ...
                <table border="0" cellspacing="1" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input size="50" type="text" name="addr1" value="${valDto.addr1}" readonly="readonly" />
                            <form:errors path="trainerValDto.addr1" /><br />
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea rows="10" cols="53" style="resize:none;"
                                name="introduction1">${valDto.introduction1}</textarea>
                        </td>
                    </tr>
                    <tr>

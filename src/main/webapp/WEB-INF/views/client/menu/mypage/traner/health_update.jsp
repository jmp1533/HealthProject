...
<html>
    ...
    <body>
        <div class="wrap">
            ...
            <h2>매장등록</h2>
            <form method="post" action="/client/menu/mypage/traner/health_update" name="frm1">
                <input type="hidden" name="b_num" value="${dto.b_num }" />
                <table border="0" cellspacing="1" cellpadding="5">
                    <tr>
                        <td>업체명</td>
                        <td>
                            <input size="30" type="text" name="b_name" value="${dto.b_name }" />
                        </td>
                    </tr>
                    <tr>
                        <td>사업자등록번호</td>
                        <td>
                            <input size="3" type="text" name="b_corporatenum1" value="${dto.b_corporatenum1 }" />
                            - <input size="2" type="text" name="b_corporatenum2" value="${dto.b_corporatenum2 }" />
                            - <input size="5" type="text" name="b_corporatenum3" value="${dto.b_corporatenum3 }" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input size="50" type="text" name="addr1" value="${dto.addr1 }" /><br />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            - <input size="5" type="text" name="b_phone2" value="${dto.b_phone2 }" />
                            - <input size="5" type="text" name="b_phone3" value="${dto.b_phone3 }" />
                        </td>
                    </tr>
                    <tr>
                        <td>이메일</td>
                        <td>
                            <input size="15" type="text" name="b_email1" value="${dto.b_email1 }" />
                            @ <input size="15" type="text" name="b_email2" id="b_email2" value="${dto.b_email2 }" />
            ...
            <form id="t_img_form" name="t_img_form" action="/seImgInsert" method="post"
                enctype="multipart/form-data">
                <table>
                    <tr>
                        <td>파일</td>
                        <td>
                            <input type="file" name="update_image" id="update_image" onchange="t_update_img();" class="fi">
                        </td>
                    </tr>
                    <tr>
                        <td>이미지</td>

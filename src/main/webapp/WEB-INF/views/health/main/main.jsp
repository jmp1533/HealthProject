    ...
    <div class="menu">
        ...
        <article class="slide" style="padding: 0;">
            <div id="img_slide_main">
                <ul id="img_slide_vUl">
                    <li id="img_slide_vLi_1"><a href="/client/menu/diary/date"><img
                                src="/resources/images/main_dairy.png" width="840px" height="360px"
                                alt='a1' /></a></li>
                    <li id="img_slide_vLi_2"><a href="/client/menu/information/movie/health_movie_list"><img
                                src="/resources/images/main_movie.png" width="840px" height="360px"
                                alt='a2' /></a></li>
                    <li id="img_slide_vLi_3"><a href="/client/menu/people/traner/list"><img
                                src="/resources/images/main_trainer.png" width="840px" height="360px"
                                alt='a3' /></a></li>
                    <li id="img_slide_vLi_4"><a href="/client/menu/finder/company/CompanyList"><img
                                src="/resources/images/main_fitness.png" width="840px" height="360px"
                                alt='a4' /></a></li>
                </ul>
            </div>
        </article>
    ...
    <div class="inner_Box">
        <div class="box_1">
            <div style="padding: 5px; margin:5px;">
                공지사항<a href="/client/menu/service/notice/Noticelist"><img
                        src="/resources/images/list_icon.png" style="float: right;" /></a>
                <div
                    style=" width:380px; height:180px; border-top-width: 1px; border-top-style: dotted; padding-top: 10px;overflow:hidden;">
                    <c:forEach var="notice1" items="${notice}" begin="0" end="5">

                        <a href="/client/menu/people/user/view?p_num=${notice1.noti_num}"
                            style="width: auto; height: auto;">${notice1.noti_title}</a>
            ...
            <div style="padding: 5px; margin:5px;">
                피플<a href="/client/menu/people/user/list"><img src="/resources/images/list_icon.png"
                        style="float: right;" /></a>
                <div
                    style=" width:380px; height:180px; border-top-width: 1px; border-top-style: dotted; padding-top: 10px;overflow:hidden;">
                    ...
                    <c:forEach var="people1" items="${people}" begin="0" end="5">
                        ...
                        <a href="/client/menu/people/user/view?p_num=${people1.p_num}"
                            style="width: auto; height: auto;">${people1.p_title}</a>
        ...
        <div class="box_2">
            <div style="padding: 5px; margin:5px;">
                건강정보<a href="/client/menu/information/news/healthsNews"><img
                        src="/resources/images/list_icon.png" style="float: right;" /></a>
                <div
                    style="width:380px; height:400px; border-top-width: 1px; border-top-style: dotted;padding-top: 10px;overflow:hidden;	">

                    <c:forEach var="nav" items="${news}" begin="0" end="5">

                        <a href="${nav.link }" style="width: auto; height: auto;"
                            target="_blank">${nav.title.toString().substring(0,15)}......</a>
                        <hr style="margin-bottom: 5px;  margin-top: 3px;">
                    </c:forEach>
        ...
        <div class="box_3">
            <div style="padding: 5px; margin:5px;">
                팁&노하우 게시판<a href="/client/menu/insert/comunity/border/tip/list"><img
                        src="/resources/images/list_icon.png" style="float: right;" /></a>
                <div
                    style="width:380px; height:180px; border-top-width: 1px; border-top-style: dotted;padding-top: 10px;overflow:hidden; ">
                    <c:forEach var="tip1" items="${tip}" begin="0" end="5">

                        <a href="/client/menu/insert/comunity/border/tip/view?tip_num=${tip1.tip_num}"
                            style="width: auto; height: auto;">${tip1.tip_title}</a>
            ...
            <div style="padding: 5px; margin:5px;">
                자유게시판<a href="/client/menu/insert/comunity/border/free/list"><img
                        src="/resources/images/list_icon.png" style="float: right;" /></a>
                <div
                    style="width:380px; height:180px; border-top-width: 1px; border-top-style: dotted; padding-top: 10px;overflow:hidden; ">
                    ...
                    <c:forEach var="free1" items="${free}" begin="0" end="5">
                        ...
                        <a href="/client/menu/insert/comunity/border/free/view?free_num=${free1.free_num}"
                            style="width: auto; height: auto;">${free1.f_title}</a>

...
<div id="imgeup" >
 ...
 <form action="/client/menu/insert/comunity/border/free/update" method="post" id="update">
 <input type="hidden" name="free_num" value="${dto.free_num}">
  <input type="hidden" name="id" value="${dto.id }">
 아이디 ${dto.id }<br>
조회 ${dto.f_hits }<br>
추천 ${dto.count }<br>
제목<input type="text" name="f_title" value="${dto.f_title}">
...
>
<textarea name="ir1" id="ir1" rows="40" cols="140" style="display: block;">${dto.f_content}</textarea>	

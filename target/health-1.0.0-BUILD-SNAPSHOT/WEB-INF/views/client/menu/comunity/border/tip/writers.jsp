...
<div class="page_list"><%--200*800사이즈로 이미지 넣을것 제작 --%>
	...
	<div class="main">
	<h2 style="border-bottom: 2px solid black; margin-bottom: 14px;">팁&노하우</h2>
 <form action="/client/menu/insert/comunity/border/tip/write" method="post" id="insert">
<input type="hidden" name="id" value="${ulogid }">
제목<input type="text" name="tip_title"><br/>
...
<div style="position: absolute; margin-top: 10px; margin-left: 630px" class="write_img">
		...
		<form id="editor_upimage" name="editor_upimage" action="/seImgInsert" method="post" enctype="multipart/form-data">
			...
			<img id="img" style="max-width: 100px; max-height: 100px" src=''><br>
			<input type="submit" onclick="pasteHTML2();" value="이미지넣기" />
		</form>
		</div>
	</div>
<textarea name="ir1" id="ir1" rows="30" cols="120" style="display: block;"></textarea><br>	
...
function pasteHTML2() {  
	  ...
	  var sHTML = "<img src="+path+" style='max-height: 300px; max-width: 300px'>";    
	  oEditors.getById["ir1"].exec("PASTE_HTML", [sHTML]);
}

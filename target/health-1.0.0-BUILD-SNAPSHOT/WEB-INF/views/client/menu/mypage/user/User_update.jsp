...
<form method="post" action="/client/menu/mypage/UpdateOk" enctype = "multipart/form-data" name="frm1">	
	<table  border="0" cellspacing="1" cellpadding="5">
		...
		<tr>
			...
			<td>
				<input size="10" type="text" name="zipcode1" value="${dto.zipcode1}" readonly="readonly"/>
				...
				<input size="50" type="text" name="addr1" value="${dto.addr1}" readonly="readonly"/><form:errors path="uservalDto.addr1"/><br/>

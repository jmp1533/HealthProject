...
<body>
<h1>회원가입</h1>
<form method="post" action="/client/user/insert/trainer/Trainer_sign_up" enctype = "multipart/form-data" name="frm1">	
<table  border="0" cellspacing="1" cellpadding="5">
		<tr>
			<td align=center bgcolor="#d3d3d3">아이디</td> 
			<td>
				<input size="20" type="text" name="id1"/>
		...
		<tr>
			...
			<td>
				<input type="text" size="23" maxlength="20" name="answer1"/>
		...
		<tr>
			...
			<td>
				<input size="20" type="text" name="name1"/>
		...
		<tr>
			...
			<td>
				<input size="20" type="text" name="birth1"/>
		...
		<tr>
			...
			<td>
				<input size="20" type="text" name="company1"/>
		...
		<tr>
			...
			<td>
				...
				<input size="50" type="text" name="addr1"/><form:errors path="trainerValDto.addr1"/><br/>
		...
		<tr>
			...
			<td>
				...
				-<input size="5" type="text" name="phone2"/>
				-<input size="5" type="text" name="phone3"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input size="15" type="text" name="email1"/>
				@ <input size="15" type="text" name="email2" id="email2"/>
		...
		<tr>
			...
			<td>
				<input size="20" type="text" name="height1"/>
		...
		<tr>
			...
			<td>
				<input size="20" type="text" name="weight1"/>
		...
		<tr>
			...
			<td>
				<textarea rows="10" cols="53" style="resize:none;" name="introduction1"></textarea>
			</td>
		</tr>
	...
	<table>
		...
		<tr>
			<td>
				<textarea rows="20" cols="59" readonly="readonly">
				</textarea></td>
			<td></td>
			<td>
				<textarea rows="20" cols="59" readonly="readonly">
		...
		<tr>
			<td><input type="checkbox" name="box" value="true" />동의함</td>
			<td></td>
			<td><input type="checkbox" name="box" value="true" />동의함</td>
		</tr>
